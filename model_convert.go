...
func (o *${structName}) cacheDuration() int {
	return 15
}
...
func (o *${structName}) getFromCache() error {
	...
	tmp, ok := ${structName}Cache.Get(o.RedisKey())
	if !ok {
...
func (o *${structName}) deleteFromCache() {
	...
	${structName}Cache.Delete(o.RedisKey())
}
...
func (o *${structName}) syncToCache() {
	...
	${structName}Cache.SetEx(o.RedisKey(), *o, o.cacheDuration())
}
...
func (o *${structName}) ArrayGetFromCache() ([]${structName}, error) {
	...
	tmp, ok := Array${structName}Cache.Get(o.ArrayRedisKey())
	if !ok {
		return nil, Array${structName}NotFoundErr
	}
	fmt.Println("get from cache")
	return tmp.([]${structName}), nil
}
...
func (o *${structName}) ArraydeleteFromCache() {
	...
	Array${structName}Cache.Delete(o.ArrayRedisKey())
}
...
func (o *${structName}) ArraySyncToCache(arr []${structName}) {
	...
	Array${structName}Cache.SetEx(o.ArrayRedisKey(), arr, o.cacheDuration() )
}
// array Tail
